...
public:
	...
	Frame(const Mat& src, bool imgFlag = true, bool grayFlag = true, bool maskFlag = true  );
	~Frame();
	...
	void setMask(const Mat& mask, int rid, int fg = 255, int bg = 0 );
	...
	void setMaskAll(const Mat& mask, int rid, int fg = 255, int bg = 0 );
    // set the mask only for this->image
    void setMaskImage(const Mat& mask, int rid, int fg = 255, int bg = 0 );
    // set the mask only for this->gray
    void setMaskGray(const Mat& mask, int rid, int fg, int bg);
